...
TEST_CENTER = 2
VAL_CENTER = 1
class Camelyon17Dataset(WILDSCFDataset):
    """
    ...
    def __init__(self, version=None, root_dir='data', download=False, split_scheme='official'):
        ...
        self._original_resolution = (3,96,96)
        ...
        self._y_size = 1
        self._n_classes = 2
        self.default_domain_fields = ['hospital']
...
class Camelyon17ClipDataset(Camelyon17Dataset):
    _dataset_name = 'camelyon17-clip'
    _versions_dict = {
        '1.0': {
